...
[![CI Pipeline](https://img.shields.io/github/actions/workflow/status/your-username/pathfind-bench/ci.yml?branch=main&style=flat-square&label=tests)](https://github.com/your-username/pathfind-bench)
